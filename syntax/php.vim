...
" Identifier
syn match phpIdentifier "\$\i*" contained contains=phpEnvVar,phpIntVar,phpVarSelector display
syn match phpIdentifierSimply "\${\i*}" contains=phpOperator,phpParent contained display
...
syn match phpIDENTIFIER "\$\i*" 
hi Identifier ctermfg=14 guifg=#fff3d2
